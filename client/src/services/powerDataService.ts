...
const toApiPayload = (
  ...
  total_energy_consumed: payload.totalEnergyConsumed,
  total_energy_generated: payload.totalEnergyGenerated,
  gas_energy_generated: payload.energyGeneratedByGas,
  diesel_energy_generated: payload.energyGeneratedByDiesel,
  generator_energy_generated: payload.energyGeneratedByGenerator,
  other_energy_generated: payload.energyGeneratedByOther,
...
const fromApiRecord = (record: Record<string, any>): PowerDataRecord => ({
  ...
  energyGeneratedByGas: record.gas_energy_generated,
  energyGeneratedByDiesel: record.diesel_energy_generated,
  energyGeneratedByGenerator: record.generator_energy_generated,
  energyGeneratedByOther: record.other_energy_generated,
