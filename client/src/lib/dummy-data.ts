...
export function generateQuestionnaire(
  ...
  return {
    ...
    totalEnergyGenerated: rand(100_000, 10_000_000),
    totalEnergyConsumed: rand(80_000, 9_000_000),
    energyGeneratedByGas: rand(0, 5_000_000),
    energyGeneratedByDiesel: rand(0, 4_000_000),
    energyGeneratedByGenerator: rand(0, 3_000_000),
    energyGeneratedByOther: rand(0, 1_000_000),
