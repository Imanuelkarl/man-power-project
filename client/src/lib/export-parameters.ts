...
export const EXPORT_PARAMETERS: ExportParameter[] = [
  ...
  //
  {
    id: "total_alt_energy_generated",
    label: "Total Alt. Energy Generated",
    category: "questionnaire",
    getValue: (ctx) => {
      return (
        (ctx.questionnaire?.energyGeneratedByDiesel || 0) +
        (ctx.questionnaire?.energyGeneratedByGas || 0) +
        (ctx.questionnaire?.energyGeneratedByGenerator || 0) +
        (ctx.questionnaire?.energyGeneratedByOther || 0)
      );
    },
    format: formatPower,
  },
  ...
  {
    id: "total_alt_energy_spent",
    label: "Total Alt. Energy Cost (₦)",
    category: "questionnaire",
    getValue: (ctx) => {
      return (
        (ctx.questionnaire?.energyOther || 0) +
        (ctx.questionnaire?.energyGenerator || 0) +
        (ctx.questionnaire?.energyDiesel || 0) +
        (ctx.questionnaire?.energyGas || 0)
      );
    },
    format: formatNumber,
  },
...
export const BASIC_PARAMETERS = [
  ...
  "total_alt_energy_spent",
  "total_alt_energy_generated",
  "electricity_hours",
];
